    ...
    >
      {["Explore NFTs", "Listed NFTs", "My NFTs"].map((item, i) => (
        <li
          ...
          className={`flex flex-row items-center font-dancingScript font-medium text-2xl dark:hover:text-white hover:text-nft-dark mx-3 ${
            active === item
              ? "dark:text-white text-nft-black"
        ...
        <Link href="/">
          ...
          >
            ...
            <Image
              ...
              alt="logo"
            />
            <p className="dark:text-white text-nft-black-1 font-extrabold text-3xl ml-2 font-dancingScript">
              CryptoSweep
            </p>
          </div>
        </Link>
