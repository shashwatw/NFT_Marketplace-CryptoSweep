          ...
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyle}>
              ...
              <div className="flexCenter flex-col text-center">
                <p className='"font-poppins dark:text-white text-nft-black-1 font-semibold text-xl'>JPG,PNG, GIF, SVG, WEBM. Max 5 MB.</p>
                ...
                <p className='"font-poppins dark:text-white text-nft-black-1 font-semibold text-sm'>Drag n Drop File</p>
